        ...
        <>
            <div className="home-container">
                <div className="home-content">
                    ...
                    <div className="row-flex-container  selected-writing">
                        <div className="row-header">
                            <h3>selected writing</h3>
                        </div>
                        <div className="row-content writing-row">
                    ...
                    <div className="row-flex-container featuring">
                        <div className="row-header">
                            <h3>featuring</h3>
                        </div>
                        <div className="row-content">
                            <div className="featured-card">
                                <h3>ROGER MOTORSPORTS LIBRARY</h3>
                            </div>
                        </div>
                    </div>
